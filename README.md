...
Aggregates the latest research articles from thirteen journals into three curated RSS 2.0 feeds, hosted via GitHub Pages.
...
| Molecular & Cell Biology Feed | `MolCellFeed.xml` | Molecular Cell, Nature Cell Biology, Nature Communications, Genome Biology, Genome Research, Nucleic Acids Research |
